...
$rowsPerPage = 50;
$pageNum = 1;
$self ="doc_add_presc.php";
$root = "doc_add_presc.php";
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="addprescription.php?pat_number=<?php echo $row->PCode;?>" class="badge badge-success"><i class="fas fa-highlighter "></i> Add Prescription</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
