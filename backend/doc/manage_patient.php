                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <div class="table-responsive">
                                <table id="" class="table table-bordered toggle-circle mb-0" data-page-size="50">
                                    <thead>
                                    <tr>
                                        <th>#</th>
                                        <th >Patient Name</th>
                                    ...
                                    */
                                    if($flag)
                                    {
                                            $sql="SELECT * FROM `patient` WHERE Phone ='".$key."' OR PCode = '".$key."' OR Fname ='".$key."' OR Lname ='".$key."'";
                                        $sql1 = $sql;
                                    ...
                                    while($row = $result->fetch_array())
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="view_single_patient.php?pat_id=<?php echo $row['PCode'];?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
                                                <a href="addprescription.php?pat_number=<?php echo $row['PCode'];?>" class="badge badge-success"><i class="fas fa-highlighter "></i> Get Examination</a>
                                                <a href="addtreatment.php?pat_number=<?php echo $row['PCode'];?>" class="badge badge-success"><i class="fas fa-highlighter "></i> Get Treatment</a>
