                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline" >
                                                ...
                                                <div class="form-group">
                                                    <form method="get" action="manage_outpatient.php">
                                    ...
                                    <div class="table-responsive">
                                        <table id="" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                            if($flag)
                                            {
                                                $sql="SELECT * FROM `outpatient` I JOIN `patient` P ON P.PCode = I.PCode WHERE I.OPCode = '".$key."' OR P.Fname LIKE '%".$key."%' OR P.Lname LIKE '%".$key."%' OR CONCAT(P.Fname, ' ', P.Lname) LIKE '".$key."'";
                                            }else
                                                $sql="SELECT * FROM `outpatient` I JOIN `patient` P ON P.PCode = I.PCode";
