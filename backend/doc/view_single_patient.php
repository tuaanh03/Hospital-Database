    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $pat_id=$_GET['pat_id'];
                $total = 0;
                $sql4 = "SELECT SUM(Fee) AS 'total' FROM examination E JOIN `outpatient` O ON O.OPCode = E.OPCode WHERE O.PCode = '".$pat_id."' ";
                $res4 = executeQuery($sql4);
                $row4 = $res4->fetch_array();
                $total += $row4['total'];
        
            $sql4 = "SELECT SUM(Fee) AS 'total' FROM treatment E JOIN `inpatient` O ON O.IPCode = E.IPCode WHERE O.PCode = '".$pat_id."' ";
            $res4 = executeQuery($sql4);
            $row4 = $res4->fetch_array();
            $total += $row4['total'];
                $ret="SELECT  * FROM `patient` P WHERE P.PCode= '".$pat_id."'";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo $row->Fname;?> <?php echo $row->Lname;?>'s Profile <?php echo $time ?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Date Of Birth :</strong> <span class="ml-2"><?php echo date("d-m-Y",strtotime($row->DoB));?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Gender :</strong> <span class="ml-2"><?php echo $row->Gender;?></span></p>

                                        <p class="text-muted mb-2 font-13"><strong>Total : </strong><span class="ml-2">$<?php echo $total;?></span></p>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="aboutme">
                                             <ul class="list-unstyled timeline-sm">
                                                <?php
                                                    ...
                                                    $ret="SELECT  * FROM `examination` E JOIN `outpatient` O ON E.OPCode = O.OPCode JOIN `patient` P ON P.PCode = O.PCode  WHERE P.PCode = '".$pat_id."' ORDER BY E.ExamDate DESC";
                                                    $res = executeQuery($ret);


                                                    // $stmt->bind_param('i',$pres_pat_number );                                               //$cnt=1;
                                                    
                                                    while($row=$res->fetch_object())
                                                        {
                                                    $mysqlDateTime = $row->ExamDate; //trim timestamp to date

                                                ?>
                                                    <li class="timeline-sm-item">
                                                        <span class="timeline-sm-date"><?php echo date("d/m/Y", strtotime($mysqlDateTime));?></span>
                                                        <h4 class="mt-0 mb-1"><?php echo $row->Diagnosis;?></h4>
                                                        <h5 class="mt-0 mb-1">Fee: $<?php echo $row->Fee;?></h5>

                                                        <p class="text-muted mt-2">
                                                            <ol>
                                                            <?php
                                                            $sql = "SELECT * FROM `examination` E JOIN `exam_use` EU ON E.ExamCode = EU.ExamCode JOIN `medication` M ON EU.MCode = M.MCode WHERE E.ExamCode = '".$row->ExamCode."'";
                                        ...
                                        <div class="tab-pane" id="settings">
                                            <ul class="list-unstyled timeline-sm">
                                                <?php
                                                $ret="SELECT  * FROM `treatment` T  JOIN `inpatient` I ON I.IPCode = T.IPCode JOIN `patient` P ON P.PCode = I.PCode WHERE P.PCode ='$pat_id' ORDER BY T.DateAdmission DESC" ;
                                                $res = executeQuery($ret);
                                                //$cnt=1;
                                                    ...
                                                    <li class="timeline-sm-item">
                                                        ...
                                                        <p class=" mt-2" style="color:<?php echo $color; ?>">
                                                            <b><?php
                                                                ...
                                                                {
                                                                    echo $row->Result;
                                                                    $sql5 = "SELECT * FROM doctor WHERE ECode = '".$row->DECode."'";
                                                        ...
                                                        <p class="text-muted mt-2">
                                                            ...
                                                            Confirmed by <?php echo $row5->Fname." ".$row5->Lname. "  -  " . $row->DECode ; ?>
                                                        </p>
                                                        <?php }?>
                                                        <hr>
